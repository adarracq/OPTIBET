...
class NextGridsPage extends StatefulWidget {

  NextGridsPage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _NextGridsPageState createState() => _NextGridsPageState();
}


class _NextGridsPageState extends State<NextGridsPage> {
  List<Grid> grids = [
    ...
    return new Center(
      child: Card(
        ...
        child: InkWell(
          ...
          onTap: () {
            Navigator.pushNamed(context, '/gridtocomplete');
          },
          child: Container(
              width: width * 0.9,
              height: height / 7,
